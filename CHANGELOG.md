...
The format is based on [Keep a Changelog](http://keepachangelog.com/en/1.0.0/) since version 4.0.0
...
## [3.9.8.5](https://github.com/mviereck/x11docker/tree/6227a1eebc5b63df305822896d7360a14440caf4) - 2018-04-05
...
## [3.9.8.4](https://github.com/mviereck/x11docker/tree/d74fa2defceb538d8c9e90932d48f23cae0f102b) - 2018-04-04
...
## [3.9.8.3](https://github.com/mviereck/x11docker/tree/6ce5d2cbd7a14556723a3c8e1163988f2ddda8ce) - 2018-04-04
- **bugfix** `--dbus-system`: **regression**: must not set `--security-opt=no-new-privileges`

## [3.9.8.2](https://github.com/mviereck/x11docker/tree/a58e6808254ce78eb528010584ff9d7ef9b8aa26) - 2018-04-03
- disable entrypoint `tini` if x11docker already runs an init system (default: `tini` from docker).

## [3.9.8.1](https://github.com/mviereck/x11docker/tree/75f79c9888beee08ca08c42c5f70feaa0f02cd30) - 2018-04-03
...
## [3.9.8.0](https://github.com/mviereck/x11docker/tree/a4067993a91f39bce145b48406453f786d1707eb) - 2018-04-02
...
## [3.9.7.8](https://github.com/mviereck/x11docker/tree/4d619bfbcae605b25ee93778936245019a8a7020) - 2018-03-31
- Handle equal signs in container environment defined with `ENV` ([#34](https://github.com/mviereck/x11docker/issues/34))

## [3.9.7.7](https://github.com/mviereck/x11docker/tree/733b8f9b9228d5fa3b167a4771976bcc610ac0de) - 2018-03-31
- Handle whitespaces in container environment defined with `ENV` ([#34](https://github.com/mviereck/x11docker/issues/34))

## [3.9.7.6](https://github.com/mviereck/x11docker/tree/65305faba992415b8b255a4fac7e89c4417e5a1e) - 2018-03-30
...
## [3.9.7.5](https://github.com/mviereck/x11docker/tree/0f0b138db7c2f3093511fae7583b34bc44db3423) - 2018-03-30
...
## [3.9.7.3](https://github.com/mviereck/x11docker/tree/57e34236dca42e05434a304c77f61202d678398a) - 2018-03-21
- `--pulseaudio`: share socket `XDG_RUNTIME_DIR/pulse` instead of connecting over tcp

## [3.9.7.2](https://github.com/mviereck/x11docker/tree/25201b916159b2f77d6c6188ea875d80004733d1) - 2018-03-20
...
## [3.9.7.1](https://github.com/mviereck/x11docker/tree/4aaa1cf3c9de7b5924a05cd1ace29e60b3903327) - 2018-03-16
...
## [3.9.7](https://github.com/mviereck/x11docker/tree/82e573068bfe78a9650f40cb5b98df9b1e08d483) - 2018-03-15
...
## [3.9.6.1](https://github.com/mviereck/x11docker/tree/1e482bc9341a6c22771b3ba602edb847e25d6d82) - 2018-03-10
...
## [3.9.6](https://github.com/mviereck/x11docker/tree/0a4166c020c9700e592c0d7600b4a8b5e9850222) - 2018-03-09
- **new option** `--lang` to set language locale in utf8, create it if missing.

## [3.9.5](https://github.com/mviereck/x11docker/tree/9a86a235f82e900d83bb0bbd4e2b85db60c5335b) - 2018-03-06
- **new option** `--keymap` to set keyboard layout

## [3.9.4.2](https://github.com/mviereck/x11docker/tree/4777416424b379dfc52240e8a32fe10bbef0a25f) - 2018-03-06
...
## [3.9.4.1](https://github.com/mviereck/x11docker/tree/68a7a529b807f40d102842ebc3fe16ca3435b771) - 2018-03-06
- **bugfix**/typo `--pulseaudio`
- share `/etc/localtime` with container to have the same time

## [3.9.4.0](https://github.com/mviereck/x11docker/tree/fa043c37d029982ed44431032f37e05f5c5f0024) - 2018-03-05
...
## [3.9.3.2](https://github.com/mviereck/x11docker/tree/f28e182de62f7f25a5458d6d1db28aee5f339eb3) - 2018-03-01
...
## [3.9.3.1](https://github.com/mviereck/x11docker/tree/7883bb089dc1ea8c438ed7be123e3bfcbd4eded2) - 2018-03-01
- fix XTEST warning messages

## [3.9.3](https://github.com/mviereck/x11docker/tree/4f8cd878dcc44469bdb9afce2f91afce3abcda8a) - 2018-03-01
...
## [3.9.2.3](https://github.com/mviereck/x11docker/tree/62e31a381b79b67a1eea9f84b629a849833249c0) - 2018-02-25
...
## [3.9.2.2](https://github.com/mviereck/x11docker/tree/699cdd4d4eb40846619233ef65edefe74e1246d0) - 2018-02-09
...
## [3.9.2.1](https://github.com/mviereck/x11docker/tree/3c28c1b61596fbc8a7e2b3ea0bbbe75dbc320fc4) - 2018-01-29
...
## [3.9.2](https://github.com/mviereck/x11docker/tree/64556a1096470761e66f15c21b5054a6cba7a734) - 2018-01-21
...
## [3.9.1.9](https://github.com/mviereck/x11docker/tree/f789a74ceab2f547b3d2939a5e23f21b32c0cd7c) - 2018-01-17
- `--xpra`: if server crashes, use xpra option `--mmap=no` on restart

## [3.9.1.8](https://github.com/mviereck/x11docker/tree/363351c54eeaad227c942bbe3eeb035085930580) - 2018-01-16
- `--xpra`: stop x11docker if xpra server crashes multiple times

## [3.9.1.7](https://github.com/mviereck/x11docker/tree/3b20fd795ac133b36702ed516e2e4efb1669f7d4) - 2018-01-15
- `--gpu`: share /dev/vga_arbiter and /dev/nvidia*

## [3.9.1.6](https://github.com/mviereck/x11docker/tree/f4797498300a30aad91985ca08269eb475826984) - 2018-01-15
- restart xpra server if it crashes (can happen with xpra 2.2, reason unknown)

## [3.9.1.5](https://github.com/mviereck/x11docker/tree/c2b217885e424e889d206018b584ca4e4caaf837) - 2018-01-13
- **bugfix** xpra: reconnect to server after timeout (60s) if switching to console

## [3.9.1.4](https://github.com/mviereck/x11docker/tree/7a4c0093bb643a3de00ab81f177b24597cc60a64) - 2018-01-12
...
## [3.9.1.3](https://github.com/mviereck/x11docker/tree/4c82febbcf6d7a568bbb117c93047c3dd666fc9d) - 2018-01-04
...
## [3.9.1.2](https://github.com/mviereck/x11docker/tree/a88992416fedc2c0b3f57def7ecd8f8e00e78bff) - 2017-12-28
...
## [3.9.1.1](https://github.com/mviereck/x11docker/tree/31f36368883ee456f4fa48c5edf0fa062b030a51) - 2017-12-28
- **bugfix** `--systemd`: directly share X socket as systemd can have issues with soft links

## [3.9.1](https://github.com/mviereck/x11docker/tree/038bf252c699b438011260ec0dc61d4192f4b5e4) - 2017-12-25
...
## [3.9.0.5](https://github.com/mviereck/x11docker/tree/a264d9b778c0c9dcf76dc5be1e2f362c120acf4f) - 2017-12-21
...
## [3.9.0.4](https://github.com/mviereck/x11docker/tree/c1b307a7f3981cf0b63aebfd2672baa319afa0ab) - 2017-12-20
...
## [3.9.0.2](https://github.com/mviereck/x11docker/tree/55923adf38ae3a5bb13373419e8e7473ab4e88eb) - 2017-12-16
...
## [3.9.0.1](https://github.com/mviereck/x11docker/tree/f95bdb31a51255c8fb8515d6d2d03542383a7301) - 2017-12-16
- **bugfix**: `--systemd`: do not set $HOME globally, root may write into it
- use /home/$Benutzer instead of /tmp/fakehome

## [3.9.0](https://github.com/mviereck/x11docker/tree/f4459cac35165c9e2dec964204505f440c9ea297) - 2017-12-15
...
## [3.8.0](https://github.com/mviereck/x11docker/tree/a9e15fc63b6ffbdad2ff0db35bdea1a5b26df336) - 2017-12-04
...
## [3.7.2](https://github.com/mviereck/x11docker/tree/e062b07b91b87a1b9b26d10e41d0d7dd1c3b6299) - 2017-11-11
...
## [3.7.1](https://github.com/mviereck/x11docker/tree/d3c841246548e9667909cc25ffad5396b0ebfde2) - 2017-11-03
...
## [3.7.0](https://github.com/mviereck/x11docker/tree/d06c59495775bfbb0bc79dea3ace02dbfb2293c9) - 2017-10-30
...
## [3.6.3.9](https://github.com/mviereck/x11docker/tree/1f4353964dba1d01289a5379a1b4d0bf10c666f1) - 2017-10-25
- show error messages regardless of `--silent`
- change `sudo` to `sudo -E`, needed for OpenSUSE
- code cleanup, some improved messages

## [3.6.3.8](https://github.com/mviereck/x11docker/tree/2e027c2b9bab8af2244fe65218276f0ad7a84736) - 2017-10-25
- fedora: set `--ipc` and `--trusted` for `--hostdisplay` only

## [3.6.3.7](https://github.com/mviereck/x11docker/tree/6034608f9d49c138d3f58b647257114b9c66052e) - 2017-10-25
- **bugfix** `--hostdisplay` on fedora: use host cookie, custom cookie is rejected

## [3.6.3.6](https://github.com/mviereck/x11docker/tree/84881c51788eecc754f36288fbb8699c5dbc327f) - 2017-10-24
...
## [3.6.3.5](https://github.com/mviereck/x11docker/tree/12bb570b2c03157d4062391288f770e520307c0f) - 2017-10-24
- **bugfix** xpra with host user root: set environment variables
- dbus-launch for konsole and terminator, needed in dockerrc

## [3.6.3.4](https://github.com/mviereck/x11docker/tree/836d4f50e44cccc587819f002faa8d18e62ecbb3) - 2017-10-23
- add /usr/sbin to PATH, needed on mageia for ip
- **bugfix** `--pw=sudo`: `setsid sudo` fails, must use `sudo setsid`

## [3.6.3.3](https://github.com/mviereck/x11docker/tree/4256438ff948dd97a0887410e866121736a1893b) - 2017-10-23
- removed experimental Code
- **bugfix** for `--wm` as root in xinitrc

## [3.6.3.2](https://github.com/mviereck/x11docker/tree/58ea47a22270ad0a7f81196cb8c69bf300e87dff) - 2017-10-23
- remove debugging `set -x` in xinitrc

## [3.6.3.1](https://github.com/mviereck/x11docker/tree/ed80f32c115066203b88b9681655c30bc2c42f13) - 2017-10-23
...
## [3.5.9](https://github.com/mviereck/x11docker/tree/623c20b427b50fc16c127c760688cfbb556c0b8b) - 2017-07-09
...
## [3.5.8](https://github.com/mviereck/x11docker/tree/fc88928119202eef80d6e3eba788fcd367dbc629) - 2017-06-07
...
## [3.5.7](https://github.com/mviereck/x11docker/tree/6d8a4cd471f31e7053a10390ab2ca3f90ae80239) - 2017-06-28
...
## [3.5.6](https://github.com/mviereck/x11docker/tree/1f6496421f958d5ebf4fcf9abbe6e5d51d19f212) - 2017-06-21
...
## [3.5.5.2](https://github.com/mviereck/x11docker/tree/547aea540aed165fc22def77724caccbd6424c63) - 2017-06-10
- update usage info for `--xpra` and `--xpra-xwayland`

## [3.5.5.1](https://github.com/mviereck/x11docker/tree/1867023c5913a09ed63f98c3d28e9b19f1b332b2) - 2017-06-10
- **bugfix** in `--auto` always choosing `--xorg`

## [3.5.5](https://github.com/mviereck/x11docker/tree/e6021187f59caef2a49b36e02417ec79591c7f1d) - 2017-06-09
...
## [3.5.4](https://github.com/mviereck/x11docker/tree/c09d6f3022ddf2c0ab6862e0f3db6ab6e9fa9c53) - 2017-06-02
...
## [3.5.3](https://github.com/mviereck/x11docker/tree/870a63b67480caedb7645011666a325dbdbb8ce7) - 2017-05-29
...
## [3.5.2](https://github.com/mviereck/x11docker/tree/d88d32605ece42324f14cf41e54482888ae539c4) - 2017-05-22
- **new option** `--volume` to share host folders

## [3.5.1](https://github.com/mviereck/x11docker/tree/4f1e4d14a904d499445fd479efb37b3c7cd46451) - 2017-05-19
- user creation with `--addgroup video` to support pre-systemd and kdeneon gpu support
- create `/tmp/.X11-unix` with `1777`

## [3.5.0](https://github.com/mviereck/x11docker/tree/2f354525b3443250c3fe4c18ebfe4a3fc57f5ca0) - 2017-05-17
...
## [3.2.1](https://github.com/mviereck/x11docker/tree/7600e599e757398d2e7ca3f53d4567f9286e31bb) - 2017-05-05
- minor **bugfix**: `--scale` with `--xpra-xwayland` under X without Wayland failed

## [3.2.0](https://github.com/mviereck/x11docker/tree/32a9b75e0a7e6511b85dd2e01353adc77b76bfb9) - 2017-05-04
...
## [3.1.16](https://github.com/mviereck/x11docker/tree/bab08db10c8b4d360c58ec7c7bb42a6fa6567b69) - 2017-05-03
- **bugfix** `--xpra-wayland` in check for `WAYLAND_DISPLAY`

## [3.1.15](https://github.com/mviereck/x11docker/tree/58536075aec99859ad212f7377724a5b60cb3dd6) - 2017-05-02
...
## [3.1.14](https://github.com/mviereck/x11docker/tree/af37faddec2642e44a0c586ac9c84694c9989fad) - 2017-05-01
...
## [3.1.13](https://github.com/mviereck/x11docker/tree/e8e428edbb259d1d317a52fb43ee7be25e5b2cf7) - 2017-04-30
...
## [3.1.12](https://github.com/mviereck/x11docker/tree/06fc8fc7f4bf2945692c8b38476e76b760bd8877) - 2017-04-29
...
## [3.1.11](https://github.com/mviereck/x11docker/tree/0248fd878cdb1b1cacd42758f883ea4dc75d0c27) - 2017-04-29
- disabled $Cidfile as not important and due to [#10](https://github.com/mviereck/x11docker/issues/10)

## [3.1.10](https://github.com/mviereck/x11docker/tree/969494282073ef5098820325472ac02872c7c5f6) - 2017-04-28
...
## [3.1.9](https://github.com/mviereck/x11docker/tree/c1eb6a60fab62bc7a10cb97020e36bf9bdb8a8ed) - 2017-04-27
- don't create Cacherootfolder in variable definitions
- check for Xvfb on Ubuntu 16.04

## [3.1.8](https://github.com/mviereck/x11docker/tree/3f4a54c01d340293a8c831b0a0757c2a97326aa2) - 2017-04-25
- Add advice for `--xorg` how to setup xserver-xorg-legacy

## [3.1.7](https://github.com/mviereck/x11docker/tree/85bb3e72ae449b2057f93390a2bbfdb86a89286a) - 2017-04-25
...
## [3.1.6](https://github.com/mviereck/x11docker/tree/2623286e141ddb4aec6a7b5162cafbb19b5c6e6c) - 2017-04-21
- **bugfix** 2 `--nxagent`: don't close nxagent on every call of nxclient

## [3.1.5](https://github.com/mviereck/x11docker/tree/a13bd270d1146ad6fedcfbb1c2ccf1583531e0d5) - 2017-04-20
- **bugfix** `--nxagent`: don't close nxagent on every call of nxclient

## [3.1.4](https://github.com/mviereck/x11docker/tree/b2641dbd874e8df51762a31c6a6d2e5344bd9efa) - 2017-04-19
- `--nxagent` supports untrusted cookies
- **bugfix**: don't set dpi if xdpyinfo fails

## [3.1.3](https://github.com/mviereck/x11docker/tree/06e021a0dae63eef02661420942b8430f7dcca42) - 2017-04-18
...
## [3.1.2](https://github.com/mviereck/x11docker/tree/289017045514d966a5f378b4649fbd2606a03c9a) - 2017-04-18
- `--nxagent` sets right keyboard layout, thanks to Ulrich!

## [3.1.1](https://github.com/mviereck/x11docker/tree/dbb3c60d525c372906e5f75fb464f8cd0f466a87) - 2017-04-18
...
## [3.1.0](https://github.com/mviereck/x11docker/tree/60b704f068fe99e64b873c8fe4fc0ae6da35ab87) - 2017-04-16
- **new option** `--nxagent` for X server `nxagent`

## [3.0.0](https://github.com/mviereck/x11docker/tree/a62b2f47472ab60b98d2a2471135e0e33fa46757) - 2017-04-15
- Wayland support.
- code cleanup
